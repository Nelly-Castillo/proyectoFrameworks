        ...
        <div className="flex flex-col gap-4 w-1/4 items-center">
          ...
          <div className="flex-col gap-1">
            <div className="flex flex-row gap-1">
              ...
              <div className="font-bold w-full text-start ">{profileData ? profileData.message.user_name : '...'}</div>
            </div>
            <div className="flex flex-row gap-1">
            ...
            {profileData?.message?.social_media_instagram && (
              <div className="flex flex-row gap-1">
                ...
                <div className="font-bold w-full text-start ">{profileData.message.social_media_instagram}</div>
              </div>
            )}
            {profileData?.message?.correo && (
              <div className="flex flex-row gap-1">
                <img className="h-7 w-7 p-2" src={mail} />
                <div className="font-bold w-full text-start ">{profileData.message.correo}</div>
              </div>
            )}
            {profileData?.message?.social_media_tiktok && (
              <div className="flex flex-row gap-1">
                <img className="h-7 w-7 p-2" src={tiktok} />
                <div className="font-bold w-full text-start ">{profileData.message.social_media_tiktok}</div>
              </div>
            )}
            {profileData?.message?.social_media_x && (
              <div className="flex flex-row gap-1">
                <img className="h-7 w-7 p-2" src={tw} />
                <div className="font-bold w-full text-start ">{profileData.message.social_media_x}</div>
              </div>
            )}
          </div>
