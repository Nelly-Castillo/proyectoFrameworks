...
const ItemCompras = ({ id_work, obra, title, artist, description, total, foto, id_purchase }) => {
    ...
    const handleCalificar = (calificacion) => {
        ...
        setIsCalifying(false);
    };

    return (
        <div className="md:flex-row justify-around py-4 my-2 shadow-2xl rounded-md w-full md:w-auto flex flex-col justify-center items-center">
                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    {isCalifying ? (
                        <div className="flex space-x-2">
                            <button onClick={() => handleCalificar(true)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hand-thumbs-up fill-VerdeCl hover:fill-green-700" viewBox="0 0 16 16">
                            ...
                            <button onClick={() => handleCalificar(false)}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-hand-thumbs-down fill-Red hover:fill-RedOs" viewBox="0 0 16 16">
                        ...
                        <button
                            onClick={() => setIsCalifying(true)}
                            className="text-lg text-black hover:text-Azul"
                        >
