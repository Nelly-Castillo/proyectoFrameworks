                ...
                <div className="flex justify-between items-center mb-4">
                    ...
                    {isCalifying ? (
                        <div className="flex space-x-2">
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16" className='fill-VerdeCl hover:fill-green-700'>
                            ...
                            >
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-down" viewBox="0 0 16 16" className='fill-Red hover:fill-RedOs'>
