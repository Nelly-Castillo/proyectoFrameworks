        ...
        <div className='flex flex-row justify-around p-2 my-3'> 
            ...
            <div className='flex  p-1 content-center'>
                <button className='pe-3'>
                    <Link  to="/Explorar">
                        <svg width="30" heght="30" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <button className='pe-3'>
                    <Link to="/Crear">
                        <svg xmlns="http://www.w3.org/2000/svg" width="35" height="30" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                ...
                <button>
                    <img src={fotoPerfil2} alt='Foto de perfil' className="rounded-full h-11 w-11 object-cover"></img>
                </button>
            </div>
        </div>
    );
